...
# 2024 season - Australia
UserPick.create!(user_id: user1.id, circuit_id: 'albert_park', driver_id_dnf: 'bottas',
  driver_id_tenth: 'hamilton', tenth_finish_position: 19, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'albert_park', driver_id_dnf: 'ricciardo',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 7, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'albert_park', driver_id_dnf: 'hulkenberg',
  driver_id_tenth: 'russell', tenth_finish_position: 17, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'albert_park', driver_id_dnf: 'stroll',
  driver_id_tenth: 'albon', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'albert_park', driver_id_dnf: 'stroll',
  driver_id_tenth: 'albon', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'albert_park', driver_id_dnf: 'ricciardo',
  driver_id_tenth: 'albon', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)

# 2024 season - Japan
UserPick.create!(user_id: user1.id, circuit_id: 'suzuka', driver_id_dnf: 'leclerc',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'suzuka', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'suzuka', driver_id_dnf: 'perez',
  driver_id_tenth: 'bottas', tenth_finish_position: 14, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'suzuka', driver_id_dnf: 'zhou',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 19, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'suzuka', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'suzuka', driver_id_dnf: 'hulkenberg',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 19, dnf_finish_position: '', season_id: 2)
...
UserPick.create!(user_id: user3.id, circuit_id: 'shanghai', driver_id_dnf: 'ocon',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'shanghai', driver_id_dnf: 'stroll',
  driver_id_tenth: 'ocon', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'shanghai', driver_id_dnf: 'perez',
  driver_id_tenth: 'bottas', tenth_finish_position: 20, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'shanghai', driver_id_dnf: 'tsunoda',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)

# 2024 season - United States (Miami)
UserPick.create!(user_id: user1.id, circuit_id: 'miami', driver_id_dnf: 'kevin_magnussen',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'miami', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'alonso', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'miami', driver_id_dnf: 'max_verstappen',
  driver_id_tenth: 'gasly', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'miami', driver_id_dnf: 'ocon',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 7, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'miami', driver_id_dnf: 'stroll',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 7, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'miami', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'stroll', tenth_finish_position: 17, dnf_finish_position: '', season_id: 2)

# 2024 season - Italy (Imola)
UserPick.create!(user_id: user1.id, circuit_id: 'imola', driver_id_dnf: 'stroll',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'imola', driver_id_dnf: 'stroll',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'imola', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'perez', tenth_finish_position: 8, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'imola', driver_id_dnf: 'stroll',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'imola', driver_id_dnf: 'albon',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 10, dnf_finish_position: 'R', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'imola', driver_id_dnf: 'ocon',
  driver_id_tenth: 'stroll', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)

# 2024 season - Monaco
UserPick.create!(user_id: user1.id, circuit_id: 'monaco', driver_id_dnf: 'sainz',
  driver_id_tenth: 'albon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'monaco', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'gasly', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'monaco', driver_id_dnf: 'hulkenberg',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'monaco', driver_id_dnf: 'stroll',
  driver_id_tenth: 'albon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'monaco', driver_id_dnf: 'stroll',
  driver_id_tenth: 'albon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'monaco', driver_id_dnf: 'gasly',
  driver_id_tenth: 'albon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)

# 2024 season - Canada
UserPick.create!(user_id: user1.id, circuit_id: 'villeneuve', driver_id_dnf: 'bottas',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 8, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'villeneuve', driver_id_dnf: 'kevin_magnussen',
  driver_id_tenth: 'sainz', tenth_finish_position: 16, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'villeneuve', driver_id_dnf: 'tsunoda',
  driver_id_tenth: 'sainz', tenth_finish_position: 16, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'villeneuve', driver_id_dnf: 'stroll',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 14, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'villeneuve', driver_id_dnf: 'max_verstappen',
  driver_id_tenth: 'sainz', tenth_finish_position: 16, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'villeneuve', driver_id_dnf: 'hulkenberg',
  driver_id_tenth: 'albon', tenth_finish_position: 17, dnf_finish_position: '', season_id: 2)

# 2024 season - Spain
UserPick.create!(user_id: user1.id, circuit_id: 'catalunya', driver_id_dnf: 'gasly',
  driver_id_tenth: 'alonso', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'catalunya', driver_id_dnf: 'stroll',
  driver_id_tenth: 'ocon', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'catalunya', driver_id_dnf: 'albon',
  driver_id_tenth: 'piastri', tenth_finish_position: 7, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'catalunya', driver_id_dnf: 'albon',
  driver_id_tenth: 'alonso', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'catalunya', driver_id_dnf: 'kevin_magnussen',
  driver_id_tenth: 'bottas', tenth_finish_position: 16, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'catalunya', driver_id_dnf: 'stroll',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)

# 2024 season - Austria
UserPick.create!(user_id: user1.id, circuit_id: 'red_bull_ring', driver_id_dnf: 'zhou',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 6, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'red_bull_ring', driver_id_dnf: 'kevin_magnussen',
  driver_id_tenth: 'ocon', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'red_bull_ring', driver_id_dnf: 'leclerc',
  driver_id_tenth: 'perez', tenth_finish_position: 7, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'red_bull_ring', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'gasly', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'red_bull_ring', driver_id_dnf: 'norris',
  driver_id_tenth: 'gasly', tenth_finish_position: 10, dnf_finish_position: 'R', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'red_bull_ring', driver_id_dnf: 'norris',
  driver_id_tenth: 'kevin_magnussen', tenth_finish_position: 8, dnf_finish_position: 'R', season_id: 2)

#2024 season - Great Britain
UserPick.create!(user_id: user1.id, circuit_id: 'silverstone', driver_id_dnf: 'zhou',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'silverstone', driver_id_dnf: 'perez',
  driver_id_tenth: 'stroll', tenth_finish_position: 7, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'silverstone', driver_id_dnf: 'perez',
  driver_id_tenth: 'albon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'silverstone', driver_id_dnf: 'stroll',
  driver_id_tenth: 'perez', tenth_finish_position: 17, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'silverstone', driver_id_dnf: 'stroll',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 6, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'silverstone', driver_id_dnf: 'ricciardo',
  driver_id_tenth: 'sargeant', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)

# 2024 season - Hungary
UserPick.create!(user_id: user1.id, circuit_id: 'hungaroring', driver_id_dnf: 'perez',
  driver_id_tenth: 'russell', tenth_finish_position: 8, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'hungaroring', driver_id_dnf: 'perez',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'hungaroring', driver_id_dnf: 'ocon',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'hungaroring', driver_id_dnf: 'albon',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'hungaroring', driver_id_dnf: 'piastri',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'hungaroring', driver_id_dnf: 'sargeant',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)

# 2024 season - Belgium
UserPick.create!(user_id: user1.id, circuit_id: 'spa', driver_id_dnf: 'perez',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 16, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'spa', driver_id_dnf: 'perez',
  driver_id_tenth: 'albon', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'spa', driver_id_dnf: 'alonso',
  driver_id_tenth: 'albon', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'spa', driver_id_dnf: 'ricciardo',
  driver_id_tenth: 'gasly', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'spa', driver_id_dnf: 'perez',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 16, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'spa', driver_id_dnf: 'norris',
  driver_id_tenth: 'ocon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)

# 2024 season - Netherlands
UserPick.create!(user_id: user1.id, circuit_id: 'zandvoort', driver_id_dnf: 'leclerc',
  driver_id_tenth: 'albon', tenth_finish_position: 14, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'zandvoort', driver_id_dnf: 'ocon',
  driver_id_tenth: 'stroll', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'zandvoort', driver_id_dnf: 'hulkenberg',
  driver_id_tenth: 'stroll', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'zandvoort', driver_id_dnf: 'zhou',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'zandvoort', driver_id_dnf: 'gasly',
  driver_id_tenth: 'sainz', tenth_finish_position: 5, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'zandvoort', driver_id_dnf: 'bottas',
  driver_id_tenth: 'sainz', tenth_finish_position: 5, dnf_finish_position: '', season_id: 2)

# 2024 season - Italy (Monza)
UserPick.create!(user_id: user1.id, circuit_id: 'monza', driver_id_dnf: 'max_verstappen',
  driver_id_tenth: 'albon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'monza', driver_id_dnf: 'colapinto',
  driver_id_tenth: 'albon', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'monza', driver_id_dnf: 'stroll',
  driver_id_tenth: 'ricciardo', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'monza', driver_id_dnf: 'colapinto',
  driver_id_tenth: 'gasly', tenth_finish_position: 15, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'monza', driver_id_dnf: 'piastri',
  driver_id_tenth: 'kevin_magnussen', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'monza', driver_id_dnf: 'stroll',
  driver_id_tenth: 'perez', tenth_finish_position: 8, dnf_finish_position: '', season_id: 2)

# 2024 season - Azerbaijan
UserPick.create!(user_id: user1.id, circuit_id: 'baku', driver_id_dnf: 'perez',
  driver_id_tenth: 'albon', tenth_finish_position: 7, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'baku', driver_id_dnf: 'norris',
  driver_id_tenth: 'colapinto', tenth_finish_position: 8, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'baku', driver_id_dnf: 'stroll',
  driver_id_tenth: 'bearman', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'baku', driver_id_dnf: 'stroll',
  driver_id_tenth: 'bearman', tenth_finish_position: 10, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'baku', driver_id_dnf: 'leclerc',
  driver_id_tenth: 'perez', tenth_finish_position: 17, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'baku', driver_id_dnf: 'zhou',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 11, dnf_finish_position: '', season_id: 2)

# 2024 season - Singapore
UserPick.create!(user_id: user1.id, circuit_id: 'marina_bay', driver_id_dnf: 'kevin_magnussen',
  driver_id_tenth: 'albon', tenth_finish_position: 20, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'marina_bay', driver_id_dnf: 'stroll',
  driver_id_tenth: 'tsunoda', tenth_finish_position: 12, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'marina_bay', driver_id_dnf: 'bottas',
  driver_id_tenth: 'alonso', tenth_finish_position: 8, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'marina_bay', driver_id_dnf: 'zhou',
  driver_id_tenth: 'hulkenberg', tenth_finish_position: 9, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user5.id, circuit_id: 'marina_bay', driver_id_dnf: 'alonso',
  driver_id_tenth: 'albon', tenth_finish_position: 20, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user6.id, circuit_id: 'marina_bay', driver_id_dnf: 'albon',
  driver_id_tenth: 'colapinto', tenth_finish_position: 11, dnf_finish_position: 'R', season_id: 2)

# 2024 season - United States (Austin)
UserPick.create!(user_id: user1.id, circuit_id: 'americas', driver_id_dnf: 'ocon',
  driver_id_tenth: 'russell', tenth_finish_position: 6, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user2.id, circuit_id: 'americas', driver_id_dnf: 'hulkenberg',
  driver_id_tenth: 'alonso', tenth_finish_position: 13, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user3.id, circuit_id: 'americas', driver_id_dnf: 'hulkenberg',
  driver_id_tenth: 'ocon', tenth_finish_position: 18, dnf_finish_position: '', season_id: 2)
UserPick.create!(user_id: user4.id, circuit_id: 'americas', driver_id_dnf: 'bottas',
...
# UserPick.create!(user_id: user2.id, circuit_id: 'vegas', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user3.id, circuit_id: 'vegas', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user4.id, circuit_id: 'vegas', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user5.id, circuit_id: 'vegas', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user6.id, circuit_id: 'vegas', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)

#2024 season - Qatar
# UserPick.create!(user_id: user1.id, circuit_id: 'losail', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user2.id, circuit_id: 'losail', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user3.id, circuit_id: 'losail', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user4.id, circuit_id: 'losail', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user5.id, circuit_id: 'losail', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user6.id, circuit_id: 'losail', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)

#2024 season - Mexico
# UserPick.create!(user_id: user1.id, circuit_id: 'yas_marina', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user2.id, circuit_id: 'yas_marina', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user3.id, circuit_id: 'yas_marina', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user4.id, circuit_id: 'yas_marina', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user5.id, circuit_id: 'yas_marina', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
# UserPick.create!(user_id: user6.id, circuit_id: 'yas_marina', driver_id_dnf: '',
#   driver_id_tenth: '', tenth_finish_position: , dnf_finish_position: '', season_id: 2)
