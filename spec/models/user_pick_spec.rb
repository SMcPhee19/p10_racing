...
RSpec.describe UserPick, vcr: { record: :new_episodes}, type: :model do
  ...
  describe 'model methods' do
    it 'can set the current race' do
      ...
      user_pick = UserPick.create!(user_id: user.id, circuit_id: "spa", driver_id_dnf: 'ocon', driver_id_tenth: 'hamilton', points_earned: 1, tenth_finish_position: 1, dnf_finish_position: "" )
    ...
    it 'can assign the finish position' do
      ...
      season = Season.create!(season_year: 2023)
      UserSeason.create!(user_id: user.id, season_id: season.id)
      user_pick = UserPick.create!(user_id: user.id, circuit_id: "spa", driver_id_dnf: 'ocon', driver_id_tenth: 'hamilton', points_earned: 1, tenth_finish_position: 1, dnf_finish_position: "R")
    ...
    it 'can calculate the points earned' do
      ...
      user_pick = UserPick.create!(user_id: user.id, circuit_id: "hungaroring", driver_id_dnf: 'ocon', driver_id_tenth: 'max_verstappen', tenth_finish_position: nil, dnf_finish_position: "")
      user_pick2 = UserPick.create!(user_id: user2.id, circuit_id: "hungaroring", driver_id_dnf: 'gasly', driver_id_tenth: 'stroll', tenth_finish_position: nil, dnf_finish_position: "")
